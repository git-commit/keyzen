...
data.consecutive = 5;
data.word_length = 7;
data.current_layout = "us-intl-german";
layouts={};
layouts["us-intl-german"] = " jfkdlsahgyturieowpqbnvmcxz6758493021`-=[]\\;',./ßäöüÄÜÖABCDEFGHIJKLMNOPQRSTUVWXYZ~!@#$%^&*()_+{}|:\"<>?";
layouts["us-intl-german-changes-only"] = "zy`-=[]\\;'.,/ßäöüÄÜÖYZ~!@#$%^&*()_+{}|:\"<>?";
layouts["code-es6"] = " {}',;():.>=</_-|`!?#[]\\+\"@$%&*~^";
